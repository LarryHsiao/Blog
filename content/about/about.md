...
我專注於 Android 與 Flutter 跨平台開發，深耕健康照護科技領域，包含遠距醫療與藍牙醫療裝置整合。專案服務橫跨北美、日本與台灣市場，重視穩定性、在地化，以及使用者是否真的用得上。

程式碼不是產出，是我選擇投入的使命。

工作之外，我把專注留在賽道 🏎️（業餘拉力賽車手）、把情緒交給旋律 🎸（吉他手），也把自由放進雪地 🏂（Snowboarding）。
