+++
title = "JWT Decoder"
description = "Decode the header and payload of a JSON Web Token. Local only — does not verify signatures."
template = "tool.html"
weight = 30
+++

<p class="tool-note">⚠️ This decodes only — it does not verify signatures. Don't paste production tokens into any web tool.</p>
...
(function () {
  ...
  const labels = { ok: 'Decoded', empty: 'Paste a JWT.', bad: 'Invalid JWT format (expected header.payload.signature).', badPart: 'Could not decode segment: ', expired: 'expired', notYet: 'not yet active', valid: 'active' };
